module.exports = (function () {
  ...
  function ExpressRedisCache(options) {
    ...
    this.client =
      this.options.client ||
      require("redis").createClient(this.port, this.host, {
    ...
    if (this.client.on) {
      ...
      this.client.on(
        ...
        function () {
          ...
          this.emit(
            "message",
            "OK connected to redis://" + this.client.address
          );
        }.bind(this)
      );
  ...
  ExpressRedisCache.prototype.get = require("./get");
  ...
  ExpressRedisCache.prototype.add = require("./add");
  ...
  ExpressRedisCache.prototype.del = require("./del");
  ...
  ExpressRedisCache.prototype.route = require("./route");
  ...
  ExpressRedisCache.prototype.size = require("./size");
